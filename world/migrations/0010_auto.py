...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field validated_by on 'Location'
        db.create_table('world_location_validated_by', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('location', models.ForeignKey(orm['world.location'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('world_location_validated_by', ['location_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field validated_by on 'Location'
        db.delete_table('world_location_validated_by')
