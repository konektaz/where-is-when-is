...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Geom.geom_simplified'
        db.add_column('world_geom', 'geom_simplified',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Geom.simplified'
        db.add_column('world_geom', 'simplified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Geom.geom_simplified'
        db.delete_column('world_geom', 'geom_simplified')

        # Deleting field 'Geom.simplified'
        db.delete_column('world_geom', 'simplified')
