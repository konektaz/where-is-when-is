...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Geom'
        db.create_table('world_geom', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('area', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['world.Area'], unique=True)),
            ('geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')()),
        ))
        db.send_create_signal('world', ['Geom'])

        # Deleting field 'Area.geom'
        db.delete_column('world_area', 'geom')


    def backwards(self, orm):
        # Deleting model 'Geom'
        db.delete_table('world_geom')


        # User chose to not deal with backwards NULL issues for 'Area.geom'
        raise RuntimeError("Cannot reverse this migration. 'Area.geom' and its values cannot be restored.")
