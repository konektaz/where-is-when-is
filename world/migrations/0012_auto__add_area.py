...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Area'
        db.create_table('world_area', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['world.Area'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=75)),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=255, populate_from='name', unique_with=())),
            ('varname', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ...
        db.send_create_signal('world', ['Area'])


    def backwards(self, orm):
        # Deleting model 'Area'
        db.delete_table('world_area')
