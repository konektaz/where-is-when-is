...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('world_location', 'zone_id')


    def backwards(self, orm):
        # Adding model 'Zone'
        db.create_table('world_zone', (
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255, null=True)),
        ...
        # User chose to not deal with backwards NULL issues for 'Location.zone'
        raise RuntimeError("Cannot reverse this migration. 'Location.zone' and its values cannot be restored.")
